...
class LLM(ABC):
    """Language model that predicts continuation of provided source code.
     ...
     The sampled function code must be trimmed! Especially using instruct-based LLM.
...
class Sampler:
    ...
    """
    _global_samples_nums: int = 1  # this variable records the global sample nums
        ...
        while True:
            ...
            try:
                ...
                for sample in samples:
                    self._global_sample_nums_plus_one()  #  add _global_sample_nums
